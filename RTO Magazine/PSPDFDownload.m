...
- (NSString *)downloadDirectory {
    ...
    NSString *downloadDirectory = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0] stringByAppendingPathComponent:@"downloads"];
...
- (void)startDownload {
//    [FlurryAnalytics logEvent:@"Issue Downloaded"];
    NSError *error = nil;
    ...
    ASIHTTPRequest *pdfRequestWeak = pdfRequest;
